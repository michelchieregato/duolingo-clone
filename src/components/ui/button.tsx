...
const buttonVariants = cva(
    'uppercase tracking-wide inline-flex items-center justify-center whitespace-nowrap rounded-xl text-sm font-bold ' +
    ...
    '',
    {
        variants: {
            variant: {
                ...
                primaryOutline: 'bg-white text-sky-400 hover:bg-slate-100 border-2 border-b-4 border-slate-200',
